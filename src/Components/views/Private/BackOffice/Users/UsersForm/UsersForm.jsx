...
const UsersForm = () => {
  const { errors, handleBlur, handleSubmit, handleChange, touched, user, loading, formik, values, setImageBase64, roles } = useUsersForm();
  ...
  return (
    <div className="container my-5">
      <div>
        <CustomTitle title={id ? "Edita usuario" : "Crea  usuario"} justify="center" wrapTextClass="text-center" wrapTitleClass="h-auto" />
      </div>
      <div className="my-5">
      ...
      <Form className="my-5 col-sm-10 col-lg-6 mx-auto" onSubmit={handleSubmit}>
        ...
        <Form.Group className="mb-3" controlId="formBasicRoleId">
          <ContainerInputError>
            ...
            <Form.Select aria-label="Seleccionar un rol" name="role_id" onChange={handleChange} onBlur={handleBlur}>
