...
import { ContainerInputError, Errors, TextArea } from "./ActivitiesForm.Styled";
import { useActivitiesForm } from './hooks/useActivitiesForm';
import  Title  from "./Title";

const ActivitiesForm = () => {
    const {values, errors, handleBlur, handleSubmit, handleChange, touched} = useActivitiesForm();
